...
--
INSERT INTO defaults (fldname, fldvalue) VALUES ('version', '2.8.12');
--
...
CREATE TABLE shipto (
  ...
  shiptoaddress1 varchar(64),
  shiptoaddress2 varchar(64),
  shiptocity varchar(64),
  shiptostate varchar(32),
  shiptozipcode varchar(32),
