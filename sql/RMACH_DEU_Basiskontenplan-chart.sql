...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('1060', 'Wertschriften mit Börsenkurs', 'A', 'A', 'AP_amount', '106', 'f', 't', '');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1103','Forderungen aus Lieferungen und Leistungen FiBu','A','A','','110',false,true,'');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('201', 'VERBINDLICHKEITEN AUS LIEFERUNGEN UND LEISTUNGEN GEGENÜBER BETEILIGTEN UND ORGANEN', 'H', 'Q', '', '201', 'f', 'f', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('2010', 'Verbindlichkeiten aus Lieferungen und Leistungen gegenüber Beteiligten und Organen', 'A', 'L', 'AP', '201', 'f', 'f', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('202', 'VERBINDLICHKEITEN AUS LIEFERUNGEN UND LEISTUNGEN GEGENÜBER BETEILIGUNGEN', 'H', 'Q', '', '202', 'f', 'f', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('2020', 'Verbindlichkeiten aus Lieferungen und Leistungen gegenüber Beteiligungen', 'A', 'L', 'AP', '202', 'f', 'f', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('30', 'NETTOERLÖSE AUS LIEFERUNGEN UND LEISTUNGEN', 'H', 'I', '', '300', 'f', 't', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('350', 'ERLÖSMINDERUNGEN AUS LIEFERUNGEN UND LEISTUNGEN', 'H', 'I', '', '350', 'f', 't', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('3500', 'Skonti LuL', 'A', 'I', 'AR_paid', '350', 'f', 't', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('54', 'LOHNAUFWAND', 'H', 'E', '', '540', 'f', 'f', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('600', 'RAUMAUFWAND', 'H', 'E', '', '600', 'f', 'f', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('6731', 'Bezugsteuer', 'A', 'E', 'AP_amount', '670', 'f', 't', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('6732', 'Vorsteuerkorrektur', 'A', 'E', 'AP_amount', '670', 'f', 't', '');
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('6733', 'Vorsteuerkürzung', 'A', 'E', 'AP_amount', '670', 'f', 't', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('69', 'FINANZAUFWAND UND FINANZERTRAG', 'H', 'E', '', '690', 'f', 'f', '');
...
INSERT INTO chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) VALUES ('80', 'AUSSERORDENTLICHER, EINMALIGER ODER PERIODENFREMDER AUFWAND UND ERTRAG', 'H', 'E', '', '800', 'f', 'f', '');
