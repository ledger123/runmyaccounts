...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1310', 'Active Accural', 'A', 'A', '', '130', 'f', 't', 'aktiverechnungsabgrenzung');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2310', 'Passive Accural', 'A', 'L', '', '230', 'f', 't', 'passiverechnungsabgrenzung');
