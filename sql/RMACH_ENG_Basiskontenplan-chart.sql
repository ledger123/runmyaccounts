...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1090','Transferaccount','A','A','AR_paid:AP_paid','109',false,true,'transfer');
