...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('1310', 'Active Creditor Accural', 'A', 'A', '', '130', 'f', 't', 'aktiverechnungsabgrenzung');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('2310', 'Passive Creditor Accural', 'A', 'L', '', '230', 'f', 't', 'passiverechnungsabgrenzung');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('630','INSURANCE','H','E','','630',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('640','ENERGY, WASTE','H','E','','640',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('660','MARKETING EXPENSES','H','E','','660',false,true,'');
...
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('695','FINANCIAL INCOME','H','E','','690',false,true,'');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('6950','Financial Income','A','E','','690',false,true,'guthabenzins');
insert into chart (accno,description,charttype,category,link,gifi_accno,contra,allow_gl,symbol_link) values ('6952','Exchange Profit','A','E','','690',false,true,'');
