...
-- Englische Texte für eigene Zwecke und um Refernz in Run my Accounts Dokumentation zu erleichtern.
-- English terms used mostly for my own reference and to make lookup in Run my Accounts documentation easier.
