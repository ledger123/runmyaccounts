...
sub countries {
	...
	@atTranslations = qw(AT �STERREICH AUSTRIA);
	...
	@ukTranslations = ("GB", "UK", "UNITED KINGDOM", "VEREINIGTES K�NIGREICH", "GREAT BRITAIN", "GROSS BRITANNIEN");
    ...
    my $countries = { 
        rma_ch_de => {
			...
			'�quatorialguinea' => 'GQ',
			'Griechenland' => 'GR',
			'S�dgeorgien und die S�dlichen Sandwichinseln' => 'GS',
			'Guatemala' => 'GT',
			'Guam' => 'GU',
			'Guinea-Bissau' => 'GW',
			'Guyana' => 'GY',
		...
		fr => {
			...
			'Syrie' => 'SY',
			'Swaziland' => 'SZ',
			'�les Turques-et-Ca�ques' => 'TC',
			'Tchad' => 'TD',
			'Terres australes et antarctiques fran�aises' => 'TF',
			'Togo' => 'TG',
			'Tha�lande' => 'TH',
			'Tadjikistan' => 'TJ',
			'Tokelau' => 'TK',
