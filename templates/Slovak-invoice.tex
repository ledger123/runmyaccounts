...
\rule{\textwidth}{1.5pt}
  ...
  \textbf{Medzisúèet} & <%sumcarriedforward%> \cr
  \end{tabularx}
...
\begin{tabularx}{\textwidth}{>{\hsize=0.4cm\centering}X@{\ }
  ...
  \textbf{pol} & \textbf{Skup} & \textbf{Èíslo} & \centering\textbf{Popis} &
...
\begin{tabularx}{12cm}{@{}>{\hsize=2.9cm\centering}X@{\ }
                       ...
                       >{\hsize=2.9cm\centering}X@{\ }
                       >{\hsize=2.9cm\raggedleft}X@{}}
  \textbf{Dátum} & \textbf{Úèet} & \textbf{È.dokladu} & \textbf{Suma} 
  \cr
<%end paid%>
<%foreach payment%>
