...
\textbf{P O N U K O V Ã   L I S T}
\hfill

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{6}{|X}|} \hline
  \textbf{Ponuka} & \textbf{DÃ¡tum} & \textbf{PlatÃ­ do} & \textbf{Kontakt} & \textbf{Miesto dodania} & \textbf{SpÃ´sob dodania} \\ [0.5ex]
  \hline
