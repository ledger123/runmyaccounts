%%%%%%%%%%%%%  TITEL  %%%%%%%%%%%%%
% Art des Templates: Offerte / sales_quotation.tex
% Mandant: 
% Erstellungsdatum: 
% Version: 
% Ersteller: 
...
\parbox{\textwidth}{
\textbf{\large{Offerte Nr. <%quonumber%>}\hfill {Datum:} <%quodate%>}
}

\vspace{0.5cm}

%Rechnungstitel
\ifthenelse{\equal{<%quodescription%>}{}}{}{
\textbf{<%quodescription%>}
\vspace{0.2cm}
}
...
<%if quototal%>
\textbf{Offertebetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{ (ohne MWST)} { inkl. MWST}}& \textbf{<%quototal%>}\\
<%end quototal%>
...
<%if quototal%>
\textbf{Offertebetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{} { inkl. MWST}}& \textbf{<%quototal%>}\\
<%end quototal%>
...
<%if quototal%>
\textbf{Offertebetrag <%currency%>}& \textbf{<%quototal%>}
<%end quototal%>
