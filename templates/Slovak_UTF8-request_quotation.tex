...
\end{tabularx}
  ...
  & \textbf{MedzisÃºÄet} & \textbf{<%sumcarriedforward%>} \\
  \end{tabularx}
...
\begin{tabularx}{\textwidth}{@{}lXrlrr@{}}
  \textbf{ÄÃ­slo} & \textbf{Popis} & \textbf{MnoÅ¾.} &
    \textbf{MJt} & \textbf{Cena} & \textbf{OÄakÃ¡vanÃ©} \\
...
\textbf{Å½IADOSÅ¤ O PONUKU}
\hfill

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{6}{|X}|} \hline
  \textbf{ÄÃ­slo} & \textbf{DÃ¡tum} & \textbf{Dodanie} & \textbf{Kontakt} & \textbf{Miesto dodania} & \textbf{SpÃ´sob dodania} \\ [0.5ex]
  \hline
...
ProsÃ­m poÅ¡lite cenovÃº ponuku a dÃ¡tum dodania pre nasledujÃºce poloÅ¾ky:

\vspace{1cm}

\begin{tabularx}{\textwidth}{@{}lXrllrr@{}}
  \textbf{ÄÃ­slo} & \textbf{Popis} & \textbf{MnoÅ¾} & &
  \textbf{ } & \textbf{Cena za jednotku} & \textbf{OÄanÃ¡vanÃ©} \\
<%foreach number%>
