...
\begin{tabularx}{\textwidth}{@{}lXrlrr@{}}
  \textbf{Èíslo} & \textbf{Popis} & \textbf{Mno¾.} &
    \textbf{MJt} & \textbf{Cena} & \textbf{Oèakávané} \\
...
\textbf{®IADOS« O PONUKU}
\hfill

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{6}{|X}|} \hline
  \textbf{Èíslo} & \textbf{Dátum} & \textbf{Dodanie} & \textbf{Kontakt} & \textbf{Miesto dodania} & \textbf{Spôsob dodania} \\ [0.5ex]
  \hline
...
Prosím po¹lite cenovú ponuku a dátum dodania pre nasledujúce polo¾ky:

\vspace{1cm}

\begin{tabularx}{\textwidth}{@{}lXrllrr@{}}
  \textbf{Èíslo} & \textbf{Popis} & \textbf{Mno¾} & &
  \textbf{ } & \textbf{Cena za jednotku} & \textbf{Oèanávané} \\
<%foreach number%>
