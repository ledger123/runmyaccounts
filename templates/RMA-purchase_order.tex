...
%%%%%%%%%%%%%  TITEL  %%%%%%%%%%%%%
% Art des Templates: Einkaufsbestellung / purchase_order.tex
% Mandant: 
% Erstellungsdatum: 
% Version: 
% Ersteller: 
...
\parbox{\textwidth}{
\textbf{\large{Einkaufsbestellung Nr. <%ordnumber%>}\hfill {Datum:} <%orddate%>}
}

\vspace{0.5cm}

%Rechnungstitel
\ifthenelse{\equal{<%orddescription%>}{}}{}{
\textbf{<%orddescription%>}
\vspace{0.2cm}
}
...
<%if ordtotal%>
\textbf{Bestellungsbetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{ (ohne MWST)} { inkl. MWST}}& \textbf{<%ordtotal%>}\\
<%end ordtotal%>
...
<%if ordtotal%>
\textbf{Bestellungsbetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{} { inkl. MWST}}& \textbf{<%ordtotal%>}\\
<%end ordtotal%>
...
<%if ordtotal%>
\textbf{Bestellungsbetrag <%currency%>}& \textbf{<%ordtotal%>}
<%end ordtotal%>
