%%%%%%%%%%%%%  TITEL  %%%%%%%%%%%%%
% Art des Templates: Auftragsbestätigung / sales_order.tex
% Mandant: 
% Erstellungsdatum: 
% Version: 
% Ersteller: 
...
\parbox{\textwidth}{
\textbf{\large{Auftragsbestätigung Nr. <%ordnumber%>}\hfill {Datum:} <%orddate%>}
}
...
%Erforderlich bis am
\ifthenelse{\equal<%reqdate%>}{}}{}{Erforderlich bis am: <%reqdate%>
\vspace{0.2cm}
}
...
<%if ordtotal%>
\textbf{Auftragsbetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{ (ohne MWST)} { inkl. MWST}}& \textbf{<%ordtotal%>}\\
<%end ordtotal%>
...
<%if ordtotal%>
\textbf{Auftragsbetrag <%currency%>\ifthenelse{\equal{<%tax%>}{}}{} { inkl. MWST}}& \textbf{<%ordtotal%>}\\
<%end ordtotal%>
...
<%if ordtotal%>
\textbf{Auftragsbetrag <%currency%>}& \textbf{<%ordtotal%>}
<%end ordtotal%>
