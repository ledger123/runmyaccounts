...
\ifthenelse{\equal{<%shiptoname%>}{}}{}{\ifthenelse{\equal{<%typeofcontact%>}{company}}{<%shiptoname%>\\}{}}
\ifthenelse{\equal{<%shiptocontact%>}{}}{}{\ifthenelse{\equal{<%salutation%>}{}}{}{<%salutation%> }<%shiptocontact%>\\}
