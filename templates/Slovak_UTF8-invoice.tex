...
%%%  Peter MÃ©szÃ¡ros -- peterm@insypo.sk       %%%
%%%                                           %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
%%% 27.4.2009
...
\rule{\textwidth}{1.5pt}
  ...
  \textbf{MedzisÃºÄet} & <%sumcarriedforward%> \cr
  \end{tabularx}
...
<%foreach tax%>
\textbf{ZÃ¡klad:} <%taxbase%> \textbf{DPH:} <%taxrate%> & <%tax%> \cr
<%end tax%>
<%if paid%>
\textbf{ZaplatenÃ©:} & -<%paid%>
<%end paid%>
\end{tabularx}

\rule{10.6cm}{1.5pt}
\begin{tabularx}{10cm}{>{\hsize=7cm\raggedleft}X>{\hsize=3cm\raggedleft}X}
\textbf{K Ãºhrade} & <%total%> \textbf{EUR}
\end{tabularx}
...
\begin{tabularx}{12cm}{@{}>{\hsize=2.9cm\centering}X@{\ }
                       ...
                       >{\hsize=2.9cm\centering}X@{\ }
                       >{\hsize=2.9cm\raggedleft}X@{}}
  \textbf{DÃ¡tum} & \textbf{ÃÄet} & \textbf{Ä.dokladu} & \textbf{Suma} 
  \cr
<%end paid%>
<%foreach payment%>
