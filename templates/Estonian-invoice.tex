...
\begin{tabularx}{\textwidth}{*{7}{|X}|} \hline
  \textbf{Arve NR.} & \textbf{KuupÃâ¬ev} & \textbf{MaksetÃâ¬htaeg} & \textbf{Tellimus NR.}
  & \textbf{MÃÅÃÅja} & \textbf{Tarneaadress} & \textbf{Tarneviis} \\ [0.5em]
  \hline
...
\begin{tabularx}{\textwidth}{@{}rlXlrlrrr@{}}
  \textbf{AR.} & \textbf{Number} & \textbf{Kirjeldus} & & \textbf{Kogus} &
    \textbf{ÃÂhik} & \textbf{Hind} & \textbf{AlH \%} & \textbf{Summa} \\ [0.5em]
<%foreach number%>
...
\begin{tabularx}{10cm}{@{}lXlr@{}}
  \textbf{Maksed} & & & \\
  \hline
  \textbf{KuupÃâ¬ev} & & \textbf{Alus} & \textbf{Summa} \\
<%end paid_1%>
<%foreach payment%>
