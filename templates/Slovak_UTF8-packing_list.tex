...
\begin{tabularx}{\textwidth}{@{}rlXllrrl@{}}
  \textbf{PoloÅ¾ka} & \textbf{ÄÃ­slo} & \textbf{Popis} & \textbf{VÃ½robnÃ© ÄÃ­slo} & & \textbf{MnoÅ¾} & \textbf{DodanÃ©} & \\
<%end pagebreak%>
...
\textbf{D O D A C Ã} \parbox{0.3cm}{\hfill} \textbf{L I S T}
\hfill

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{7}{|X}|} \hline
  \textbf{FaktÃºra \#} & \textbf{ObjednÃ¡vka \#} & \textbf{DÃ¡tum} & \textbf{Kontakt}
  <%if warehouse%>
  & \textbf{Sklad}
  <%end warehouse%>
