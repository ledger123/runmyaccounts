...
\begin{tabularx}{\textwidth}{@{}rlXlrlrrr@{}}
  \textbf{Pol} & \textbf{ÄÃ­slo} & \textbf{Popis} & & \textbf{MnoÂ} &
...
\textbf{D O D Ã V A T E L S K Ã \hspace{0.3cm} F A K T Ã R A}

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{8}{|X}|} \hline
  \textbf{FaktÃºra} & \textbf{DÃ¡tum} & \textbf{SplatnosÂ} & \textbf{ObjednÃ¡vka}
  & \textbf{Kontakt}
  <%if shippingpoint%>
...
\begin{tabularx}{10cm}{@{}lXlr@{}}
  ...
  \hline
  \textbf{DÃ¡tum} & & \textbf{Doklad} & \textbf{Suma} \\
<%end paid_1%>
<%foreach payment%>
