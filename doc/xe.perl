...
my $trendsurl = "http://free.currencyconverterapi.com/api/v5/convert?q=CHF_EUR&compact=y";
my $json      = get($trendsurl);
die "Could not get $trendsurl!" unless defined $json;
my $decoded_json = decode_json($json);
my $chf          = $decoded_json->{'CHF_EUR'}->{'val'};

$trendsurl = "http://free.currencyconverterapi.com/api/v5/convert?q=USD_EUR&compact=y";
$json      = get($trendsurl);
die "Could not get $trendsurl!" unless defined $json;
